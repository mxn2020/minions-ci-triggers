...
/**
 * @minions-ci-triggers/cli — CLI for Minions Ci-triggers
 *
...
import { customTypes } from '@minions-ci-triggers/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Ci-triggers'));
        console.log(chalk.dim('Code/prompt change listeners, CI/CD hooks, and regression gate definitions'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-ci-triggers/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-ci-triggers/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-ci-triggers')}`);
