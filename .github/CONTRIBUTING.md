# Contributing to Minions Ci-triggers

Thank you for your interest in contributing to Minions Ci-triggers!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-ci-triggers.git`
