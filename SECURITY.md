...
- `@minions-ci-triggers/sdk` (npm package)
- `minions-ci-triggers` (PyPI package)
- `@minions-ci-triggers/cli` (npm package)
- The minions-ci-triggers web playground
- The minions-ci-triggers documentation site
